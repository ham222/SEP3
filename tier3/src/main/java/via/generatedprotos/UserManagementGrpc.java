...
public final class UserManagementGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<via.generatedprotos.Username,
      via.generatedprotos.User> getGetUserByUsernameMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetUserByUsername",
      requestType = via.generatedprotos.Username.class,
      responseType = via.generatedprotos.User.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<via.generatedprotos.Username,
      via.generatedprotos.User> getGetUserByUsernameMethod() {
    io.grpc.MethodDescriptor<via.generatedprotos.Username, via.generatedprotos.User> getGetUserByUsernameMethod;
    if ((getGetUserByUsernameMethod = UserManagementGrpc.getGetUserByUsernameMethod) == null) {
      synchronized (UserManagementGrpc.class) {
        if ((getGetUserByUsernameMethod = UserManagementGrpc.getGetUserByUsernameMethod) == null) {
          UserManagementGrpc.getGetUserByUsernameMethod = getGetUserByUsernameMethod =
              io.grpc.MethodDescriptor.<via.generatedprotos.Username, via.generatedprotos.User>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetUserByUsername"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  via.generatedprotos.Username.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  via.generatedprotos.User.getDefaultInstance()))
              .setSchemaDescriptor(new UserManagementMethodDescriptorSupplier("GetUserByUsername"))
              .build();
        }
      }
    }
  ...
  public static abstract class UserManagementImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getUserByUsername(via.generatedprotos.Username request,
        io.grpc.stub.StreamObserver<via.generatedprotos.User> responseObserver) {
  ...
  public static final class UserManagementBlockingStub extends io.grpc.stub.AbstractBlockingStub<UserManagementBlockingStub> {
    ...
    /**
     */
    public via.generatedprotos.User getUserByUsername(via.generatedprotos.Username request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class UserManagementFutureStub extends io.grpc.stub.AbstractFutureStub<UserManagementFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<via.generatedprotos.User> getUserByUsername(
        via.generatedprotos.Username request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final int METHODID_GET_USER_BY_USERNAME = 3;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_USER_BY_USERNAME:
          serviceImpl.getUserByUsername((via.generatedprotos.Username) request,
              (io.grpc.stub.StreamObserver<via.generatedprotos.User>) responseObserver);
          break;
